...
export const CHARACTER_CLASSES: CharacterClass[] = [
  {
    ...
    description: 'Can talk their way into (or out of) anything. High Rizz.',
  },
  {
    name: 'The Tank',
    emoji: '🛡️',
    tagline: 'Last one standing, every time.',
    description: 'Soaks up punishment and keeps the night rolling. High Stamina.',
  },
  {
    name: 'The Wildcard',
    emoji: '🎲',
    tagline: 'Nobody knows what happens next. Not even them.',
    description: 'Unpredictable chaos energy. Rides on pure Vibes.',
  },
  {
    name: 'The Strategist',
    emoji: '🧠',
    tagline: 'Already planned the next three venues.',
    description: 'Always two moves ahead. High Shenanigans.',
  },
  {
    name: 'The Menace',
    emoji: '😈',
    tagline: 'Banned from at least one establishment.',
    description: 'Brings the mischief. Thrives on Shenanigans and trouble.',
  },
  {
    name: 'The Bard',
    emoji: '🎤',
  ...
  },
  {
    ...
    description: 'The quiet hero who gets everyone home. High Stamina & Shenanigans.',
  },
  {
